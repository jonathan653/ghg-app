  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput("ElectricitySlider",
                  ...
                  max = 5,
                  value = 1),
      bsPopover("ElectricitySlider", "Rate of conversion to renewable energy", "The degree to which the energy used by University is generated by renewable energy. The goal is to change all the fossil fuel sources such as coal and gas to renewable energy. Note: the slider bar represents five scenarios  with 1 = maintaining current state till 2032, 3 = having 95% renewable energy by 2032,  and 5 = having 100% renewable energy by 2032", trigger = "hover",
                options = NULL)
    ),
